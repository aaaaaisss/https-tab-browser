...
for (const required of ['youtubeSabrDelayFixScript', 'youtubeSabrDelayFixScriptHandler', 'aggressiveAdBlockingEnabled']) {
  if (!source.includes(required)) throw new Error(`WebView registration lacks: ${required}`);
}
console.log('Brave SABR resource and aggressive-mode registration: OK');
