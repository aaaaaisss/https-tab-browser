...
console.log('Browser stabilization, safe blob downloads, menu-based HTML5 video controls, recoverable PiP, favicon cache, retained history state, and dark-page exclusion: OK');
